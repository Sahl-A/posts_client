...
export declare const MediaApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    uploadOneMedia(file: any, entityType: string, entityId: string, options?: any): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<InlineResponse200>>;
};
/**
...
export declare const MediaApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    uploadOneMedia(file: any, entityType: string, entityId: string, options?: any): AxiosPromise<InlineResponse200>;
};
/**
...
export declare class MediaApi extends BaseAPI {
     ...
     * @memberof MediaApi
     */
    uploadOneMedia(file: any, entityType: string, entityId: string, options?: any): Promise<import("axios").AxiosResponse<InlineResponse200>>;
}
/**
...
export declare const PostsApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    getPosts(offset?: number | undefined, limit?: number | undefined, options?: any): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<FeedResponse>>;
};
/**
...
export declare const PostsApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    getPosts(offset?: number | undefined, limit?: number | undefined, options?: any): AxiosPromise<FeedResponse>;
};
/**
...
export declare class PostsApi extends BaseAPI {
     ...
     * @memberof PostsApi
     */
    getPosts(offset?: number, limit?: number, options?: any): Promise<import("axios").AxiosResponse<FeedResponse>>;
}
/**
...
export declare const VotesApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    addVote(optionid: string, options?: any): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<Array<InlineResponse2001>>>;
};
/**
...
export declare class VotesApi extends BaseAPI {
     ...
     * @memberof VotesApi
     */
    addVote(optionid: string, options?: any): Promise<import("axios").AxiosResponse<InlineResponse2001[]>>;
}
