...
export const MediaApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        uploadOneMedia: async (file: any, entityType: string, entityId: string, options: any = {}): Promise<RequestArgs> => {
            ...
            assertParamExists('uploadOneMedia', 'file', file)
            // verify required parameter 'entityType' is not null or undefined
            assertParamExists('uploadOneMedia', 'entityType', entityType)
            // verify required parameter 'entityId' is not null or undefined
            assertParamExists('uploadOneMedia', 'entityId', entityId)
...
export const MediaApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async uploadOneMedia(file: any, entityType: string, entityId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse200>> {
...
export const PostsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getPosts(offset?: number, limit?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FeedResponse>> {
...
export const PostsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getPosts(offset?: number, limit?: number, options?: any): AxiosPromise<FeedResponse> {
